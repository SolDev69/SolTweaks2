...
public class ModBlocks {
    ...
    public static final Block CONTAINER_BLOCK = register(
            "container",
            ContainerBlock::new,
    ...
    private static ResourceKey<Block> keyOfBlock(String name) {
        return ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SolTweaks2.MOD_ID, name));
    }

    private static ResourceKey<Item> keyOfItem(String name) {
        return ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(SolTweaks2.MOD_ID, name));
    }
}